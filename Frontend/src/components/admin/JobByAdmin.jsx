...
import JobByAdminTable from "./JobByAdminTable";
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 tracking-tight">
                Posted <span className="bg-gradient-to-r from-[#6A38C2] to-indigo-600 bg-clip-text text-transparent">Jobs</span>
              </h1>
              <p className="text-sm text-gray-500 mt-1 max-w-xl">
                Manage your job postings, track applicant submissions, and publish new job opportunities.
              </p>
            </div>
        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 sm:p-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-4 border-b border-gray-100">
            ...
            <span className="text-xs text-gray-400 self-end sm:self-center font-medium">
              Showing all jobs posted by you
            </span>
          </div>
